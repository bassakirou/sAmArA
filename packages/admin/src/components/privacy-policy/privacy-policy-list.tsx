...
import { SortOrder, MappedPaginatorInfo, PrivacyPolicy } from '@/types';
...
export type IProps = {
  privacyPolicies: any | undefined | null;
...
const PrivacyPolicyList = ({
  ...
  const columns: any = [
    ...
    },
    {
      ...
      key: 'actions',
      align: alignRight,
      render: (slug: string, record: PrivacyPolicy) => (
        <LanguageSwitcher
          slug={slug}
          record={record}
          deleteModalView="DELETE_PRIVACY"
          routes={Routes?.privacyPolicies}
        />
      ),
    },
  ];
