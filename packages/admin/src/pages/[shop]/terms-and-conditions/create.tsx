...
export default function ShopTermsCreatePage() {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    const nextSections: TermsSection[] = [
      ...sections,
      {
        title: values.title.trim(),
        description: values.description.trim(),
        order: Number(values.order ?? sections.length),
      },
...
ShopTermsCreatePage.authenticate = {
  permissions: adminOwnerAndStaffOnly,
};
ShopTermsCreatePage.Layout = ShopLayout;
