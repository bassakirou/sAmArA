  ...
  const layoutClassName = {
    ...(layout === 'newsletter'
      ? {
          ...
          buttonClassName: 'w-full h-12 lg:h-14 mt-3 sm:mt-4 bg-green-600',
      ...
      : {
          ...
          buttonClassName:
            'mt-3 sm:mt-0 w-full sm:w-auto ltr:sm:ml-2 rtl:sm:mr-2 md:h-full flex-shrink-0 bg-green-600',
          buttonTextClassName: 'lg:py-0.5',
        }),
  };
