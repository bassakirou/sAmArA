...
const Subscription: React.FC<Props> = ({
  ...
  return (
    <div
      className={`${className} flex flex-col justify-center xl:justify-between items-center rounded-lg bg-gray-200 py-10 md:py-14 lg:py-16 ${
        variant === 'default' ? 'xl:flex-row' : ''
      }`}
    >
      <div
        className={`-mt-1.5 lg:-mt-2 xl:-mt-0.5 text-center ltr:xl:text-left rtl:xl:text-right ${
          variant === 'default'
